    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='assigned_user', to=settings.AUTH_USER_MODEL)),
